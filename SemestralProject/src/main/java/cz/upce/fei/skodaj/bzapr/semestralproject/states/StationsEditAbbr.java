...
public class StationsEditAbbr extends State
{
    ...
    public void HandleInput(String input)
    {
        ...
        {
            if (cz.upce.fei.skodaj.bzapr.semestralproject.data.Stations.GetInstance().CheckFreeAbbr(input.toLowerCase()) == false && !input.toLowerCase().equals(this.stationAbbr.toLowerCase()))
            {
